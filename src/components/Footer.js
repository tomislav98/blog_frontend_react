  ...
  return (
    <footer>
      <div className="footer-content-1">
        <p>
          Your friendly guide through the world of code and tech. Join us as we
          explore new technologies, share coding tips, and simplify complex
      ...
      <div className="footer-content-3">
        ...
        <p>
          Stay in the loop! Subscribe to get the latest updates, news, and tips

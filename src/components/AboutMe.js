            ...
            <div className={`section-1 ${inView ? "animate" : ""}`} ref={ref}>
              <div className="card">
                ...
                <p>
                  ...
                  modern, user-friendly applications. I specialize in front-end
                  development using React and Angular, creating clean and
                  responsive interfaces. On the back-end, I work with powerful
                  frameworks to design robust APIs and scalable systems.
                </p>
              </div>
            </div>
